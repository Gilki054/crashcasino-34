...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-387d18bb');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-387d18bb');}
...
function clearFlash(){dieView.classList.remove('rl-win-387d18bb');dieView.classList.remove('rl-lose-387d18bb');if(frameEl){frameEl.classList.remove('rl-win-387d18bb');frameEl.classList.remove('rl-lose-387d18bb');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-387d18bb');if(frameEl){frameEl.classList.add('rl-win-387d18bb');}}else{dieView.classList.add('rl-lose-387d18bb');if(frameEl){frameEl.classList.add('rl-lose-387d18bb');}}
...
var brandEl=document.querySelector('.rl-brand-387d18bb');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
